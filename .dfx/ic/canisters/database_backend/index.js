...
export const canisterId = process.env.CANISTER_ID_DATABASE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./database_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the database_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./database_backend.did.js")._SERVICE>}
 */
export const database_backend = createActor(canisterId);
